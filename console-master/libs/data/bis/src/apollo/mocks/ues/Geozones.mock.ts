...
export const GeozonesQueryResultMock = {
  geozones,
}

export const CreateGeozoneMutationResultMock = { createGeozone: geozones[0] }

export const UpdateGeozoneMutationResultMock = { updateGeozone: geozones[0] }

export const DeleteGeozonesMutationResultMock = { deleteGeozones: { success: ['af739578-ab38-f948-1cff-dd83957ba7c6'], fail: [] } }
