...
interface PolicyAssignedUsersProps {
  readOnly: boolean
}

export const PolicyAssignedUsers = memo<PolicyAssignedUsersProps>(({ readOnly }) => {
  ...
  const {
    ...
    setSearchTerm,
    setSortDirection,
  } = useBaseProfileAssignmentsData(ServiceId.BIS, ReconciliationEntityType.BISDetectionPolicy, entityId, notify)
