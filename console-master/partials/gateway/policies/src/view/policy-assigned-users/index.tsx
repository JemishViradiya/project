...
const PolicyAssignedUsers: React.FC<PolicyComponentInterface> = ({ entityType }) => {
  const { id, policyType } = useParams()
  ...
  const {
    ...
    setSearchTerm,
    setSortDirection,
  } = useBaseProfileAssignmentsData(ServiceId.BIG, entityType, id, notify)
