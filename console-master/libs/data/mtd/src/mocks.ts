...
export const MtdPolicyMock = {
  ...
  androidUnsupportedModelEnabled: true,
  androidUnsupportedModelList: [
    { name: 'Acer', brands: [{ name: 'Acer Iconia Tab 8', models: ['A1-840FHD'] }] },
    { name: 'asus', brands: [{ name: 'ASUS Padphone', models: ['ASUS_T00N'] }] },
    { name: 'huawei', brands: [{ name: 'Ascend' }, { name: 'Ascend', models: ['HUAWEI G525-U00'] }] },
  ],
  ...
  androidMaliciousAppEnabledEmailNotify: false,
  androidSideLoadedAppEnabledDeviceNotify: false,
  androidSideLoadedAppEnabledEmailNotify: true,
  androidPrivilegeEscalationEnabledDeviceNotify: true,
  androidPrivilegeEscalationEnabledEmailNotify: false,
  androidScreenLockDisabledDeviceNotify: false,
  androidScreenLockDisabledEmailNotify: true,
  androidKnoxAttestationEnabledDeviceNotify: false,
  androidKnoxAttestationEnabledEmailNotify: true,
  androidDeveloperModeDetectionEnabledDeviceNotify: false,
  androidDeveloperModeDetectionEnabledEmailNotify: true,
  androidEncryptionDisabledDeviceNotify: true,
  androidEncryptionDisabledEmailNotify: false,
  androidUnsupportedOsEnabledDeviceNotify: false,
  androidUnsupportedOsEnabledEmailNotify: true,
  androidHwAttestationEnabledDeviceNotify: true,
  androidHwAttestationEnabledEmailNotify: false,
  androidHwAttestationSecurityPatchEnabledDeviceNotify: true,
  androidHwAttestationSecurityPatchEnabledEmailNotify: false,
  androidSafetynetAttestationEnabledDeviceNotify: false,
  androidSafetynetAttestationEnabledEmailNotify: true,
  androidCompromisedNetworkEnabledDeviceNotify: true,
  androidCompromisedNetworkEnabledEmailNotify: false,
  androidMessageScanningEnabledDeviceNotify: false,
  androidMessageScanningEnabledEmailNotify: true,
  androidInsecureWifiEnabledDeviceNotify: true,
  androidInsecureWifiEnabledEmailNotify: false,
  androidUnsupportedModelEnabledDeviceNotify: false,
  ...
  iosUnsupportedModelEnabledEmailNotify: false,
  iosSideLoadedAppEnabledDeviceNotify: false,
  iosSideLoadedAppEnabledEmailNotify: true,
  iosPrivilegeEscalationEnabledDeviceNotify: true,
  iosPrivilegeEscalationEnabledEmailNotify: false,
  iosScreenLockDisabledDeviceNotify: false,
  iosScreenLockDisabledEmailNotify: true,
  iosUnsupportedOsEnabledDeviceNotify: true,
  iosUnsupportedOsEnabledEmailNotify: false,
  iosIntegrityCheckAttestationEnabledDeviceNotify: false,
  iosIntegrityCheckAttestationEnabledEmailNotify: true,
  iosCompromisedNetworkEnabledDeviceNotify: false,
...
export { nonCompliantMock } from './compliance/compliance-mock'
