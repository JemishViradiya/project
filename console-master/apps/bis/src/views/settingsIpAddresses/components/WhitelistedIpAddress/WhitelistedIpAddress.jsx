...
import { CONFIRM_DELETE_TRUSTED_IP_ADDRESSES } from '../../../../config/consts/dialogIds'
...
const WhitelistedIpAddress = memo(
  ({
    onSort,
    onClose,
    canEdit,
    ...
    const openDeleteDialog = useCallback(
      ipAddresses => setDeleteDialog({ dialogId: CONFIRM_DELETE_TRUSTED_IP_ADDRESSES, toDelete: ipAddresses }),
      [],
    )
    ...
    return (
      <>
        <p>{t('settings.ipAddress.trustedListInfo')}</p>
        <Header
          isSubHeader
          ...
          name="whitelist-ip-address-search"
          onExport={onExport}
...
WhitelistedIpAddress.displayName = 'WhitelistedIpAddress'

WhitelistedIpAddress.propTypes = {
