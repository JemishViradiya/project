...
import { EDIT_TRUSTED_IP_ADDRESSES } from '../../../../config/consts/dialogIds'
...
import WhitelistedIpAddress from './WhitelistedIpAddress'

const INITIAL_STATE = {
  offset: ipAddressesQueryParams.OFFSET,
  size: ipAddressesQueryParams.SIZE,
}
const IS_BLACKLIST = false
...
const WhitelistedIpAddressContainer = memo(() => {
  const { t } = useTranslation()
  const [state] = useState(INITIAL_STATE)
  const [editDialog, setEditDialog] = useState({})
  const openEditDialog = useEventHandler(() => setEditDialog({ dialogId: EDIT_TRUSTED_IP_ADDRESSES }), [])
...
WhitelistedIpAddressContainer.displayName = 'WhitelistedIpAddressContainer'

export default WhitelistedIpAddressContainer
